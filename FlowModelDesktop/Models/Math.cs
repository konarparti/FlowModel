...
namespace FlowModelDesktop.Models
{
    public class Math
    {
        ...
        public void Calculation(InputData inputData, DbData dbData, out decimal Q, out decimal Tp, out decimal Etap)
        {
            ...
            Q = dbData.ro * Qch;
            Tp = T_List[T_List.Count-1];
            Etap = eta_List[eta_List.Count-1];
        }
    }
}
